...
// Asset loading system for Animal Crossing Vita
// Loads assets from ux0:data/AnimalCrossing/assets/ at runtime
...
#define AC_ASSETS_BASE_PATH "ux0:data/AnimalCrossing/assets/"
