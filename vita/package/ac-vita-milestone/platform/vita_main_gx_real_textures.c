...
int main(void) {
    printf("🎮 Starting Real AC-Decomp Texture GX Wrapper\n");
    printf("🔧 This version loads REAL Animal Crossing textures:\n");
    printf("   1. Same direct VitaGL init (bypasses crash sources)\n");
    printf("   2. Loads actual AC-Decomp extracted textures\n");
    printf("   3. Runtime texture loading (after successful init)\n");
    printf("   4. Real character, item, and UI textures\n");
    printf("   5. Demonstrates actual game content rendering\n");
    printf("\n");
